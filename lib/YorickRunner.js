...
module.exports.YorickRunner = (runnerConfig) => {
  async function run() {
    ...
    try {
      ...
      try {
        // TODO: use the CLI to build images instead (because this is slow and the file jimmying is whack)
        // TODO: test this speed vs. the CLI?
      ...
      docker.run(imageTag, ['npx', '-y', 'cowsay', 'heyyy'], process.stdout).then(function(data) {

        // TODO: docker exec all the tests in here
